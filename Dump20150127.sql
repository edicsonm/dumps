...
CREATE TABLE `Certificate` (
  ...
  `Cert_ExpirationDate` varchar(50) NOT NULL,
  `Cert_FingerPrint` varchar(50) NOT NULL,
  `Cert_Status` enum('0','1') NOT NULL,
  ...
  KEY `UNIQUE_Merc_ID_Cert_Status` (`Merc_ID`,`Cert_Status`),
...
-- Dump completed on 2015-01-27  7:51:22
