...
CREATE TABLE `CountryRestriction` (
  ...
  `Coun_Numeric` int(5) NOT NULL,
  `Core_Volume` varchar(45) DEFAULT NULL,
  `Core_Amount` varchar(45) DEFAULT NULL,
  `Core_AmountTimeRange` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`Core_ID`),
...
--
/*!50003 DROP PROCEDURE IF EXISTS `copiar` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `copiar`()
BEGIN
	 DECLARE done INT DEFAULT FALSE;
    DECLARE Coun_Numeric varchar(250) default '';
    DECLARE Coun_Name varchar(250) default '';
    DECLARE registros CURSOR FOR SELECT `Country`.`Coun_Numeric`,`Country`.`Coun_Name` FROM `IPG`.`Country`;
    DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;
    OPEN registros;
	read_loop: LOOP
		FETCH registros INTO Coun_Numeric, Coun_Name;
		IF done THEN
			LEAVE read_loop;
		END IF;
        INSERT INTO `IPG`.`Currency` (`Coun_Numeric`, `Coun_Name`) VALUES (Coun_Numeric, Coun_Name);
	END LOOP;
  CLOSE registros;
END ;;
DELIMITER ;
...
-- Dump completed on 2015-01-14 10:41:24
