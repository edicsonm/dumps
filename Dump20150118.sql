...
CREATE TABLE `Merchant` (
  ...
  `Merc_UrlDeny` varchar(100) NOT NULL,
  `Merc_UrlApproved` varchar(100) NOT NULL,
  PRIMARY KEY (`Merc_ID`),
...
INSERT INTO `Merchant` VALUES (1,170,'Tuticket.com.co','0','2015-01-18 18:49:50','http://192.168.0.10:8080/MerchantApp/answerError.jsp','http://192.168.0.10:8080/MerchantApp/answerProcessor.jsp'),(2,862,'Tucarro.com.ve','0','2015-01-16 21:29:55','',''),(3,862,'Tutickewwwww','1','2015-01-16 21:21:25','','');
...
CREATE TABLE `MerchantRestriction` (
  ...
  `Mere_Concept` varchar(50) NOT NULL,
...
INSERT INTO `MerchantRestriction` VALUES (1,2,1000,'Amount','1440','0','2015-01-17 09:24:50'),(2,2,101,'Amount','1440','0','2015-01-17 09:24:55');
...
`P_Merc_UrlDeny ` varchar(100),
`P_Merc_UrlApproved ` varchar(100),
INOUT `P_Merc_ID` bigint(20))
BEGIN
...
BEGIN
    ...
    `Merc_UrlDeny` = P_Merc_UrlDeny,
	`Merc_UrlApproved` = P_Merc_UrlApproved,
    `Merc_CreateTime` = now()
	WHERE `Merc_ID` = P_Merc_ID;   
END ;;
DELIMITER ;
...
-- Dump completed on 2015-01-18 19:31:08
