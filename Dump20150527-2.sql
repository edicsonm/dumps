...
-- Dump completed on 2015-05-27 12:02:20
-- MySQL dump 10.13  Distrib 5.6.19, for Linux (x86_64)
--
...
CREATE TABLE `Daily_Subscriptions` (
  ...
  `Dasu_ProcessAttempt` int(2) NOT NULL DEFAULT '0',
  `Dasu_ProcessAttemptLimit` int(2) NOT NULL DEFAULT '3',
...
) ENGINE=InnoDB AUTO_INCREMENT=14986 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
BEGIN
    ...
    IF NEW.Dasu_Status = 'Charged' THEN
		...
		SET `Subs_CurrentPeriodStart` = NEW.Dasu_CurrentPeriodStart,
            ...
            `Subs_CurrentChargeStatusDate` = NOW()
		WHERE `Subs_ID` = NEW.Subs_ID;
        DELETE FROM IPG.Daily_Subscriptions WHERE `Subs_ID` = NEW.Subs_ID;
    END IF;
    
    IF NEW.Dasu_Status = 'Unpaid' THEN
		IF  NEW.Dasu_ProcessAttempt = (NEW.Dasu_ProcessAttemptLimit - 1) THEN 
			UPDATE `IPG`.`Subscription`
...
) ENGINE=InnoDB AUTO_INCREMENT=13181 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PROC_SEARCH_DAILY_UNPAID_SUBSCRIPTION` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PROC_SEARCH_DAILY_UNPAID_SUBSCRIPTION`()
BEGIN
	SELECT A.Dasu_ID, A.Subs_ID, A.Merc_ID, A.Dasu_CurrentPeriodStart, A.Dasu_CurrentPeriodEnd, 
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PROC_SEARCH_DAILY_UNPAID_SUBSCRIPTION_BLOCKED` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PROC_SEARCH_DAILY_UNPAID_SUBSCRIPTION_BLOCKED`()
BEGIN
	SELECT COUNT(*) Count
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PROC_UPDATE_UNPAID_DAILY_SUBSCRIPTION` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PROC_UPDATE_UNPAID_DAILY_SUBSCRIPTION`(
P_Dasu_Status enum('Waiting','Sending','BBError','Charged','Unpaid'),
