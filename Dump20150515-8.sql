...
-- Dump completed on 2015-05-15 20:10:25
-- MySQL dump 10.13  Distrib 5.6.19, for Linux (x86_64)
--
...
--
-- Table structure for table `AUX_Subscriptions`
--

DROP TABLE IF EXISTS `AUX_Subscriptions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `AUX_Subscriptions` (
  `Subs_ID` bigint(20) NOT NULL DEFAULT '0',
  `Plan_ID` bigint(20) DEFAULT NULL,
  `Mcca_ID` bigint(20) DEFAULT NULL,
  `Subs_Quantity` int(4) DEFAULT NULL,
  `Subs_CurrentPeriodStart` date DEFAULT NULL,
  `Subs_CurrentPeriodEnd` date DEFAULT NULL,
  `Subs_CreationTime` datetime DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Daily_Subscriptions_AFTER_INSERT` AFTER INSERT ON `Daily_Subscriptions` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Daily_Subscriptions_AFTER_UPDATE` AFTER UPDATE ON `Daily_Subscriptions` FOR EACH ROW
BEGIN
	IF NEW.Dasu_Status = 'Charged' THEN
		UPDATE `IPG`.`Subscription`
		SET `Subs_CurrentPeriodStart` = NEW.Dasu_CurrentPeriodStart,
			`Subs_CurrentPeriodEnd` = NEW.Dasu_CurrentPeriodEnd,
            `Subs_Status` = 'Active',
    ...
    IF NEW.Dasu_Status = 'Unpaid' THEN		
        UPDATE `IPG`.`Subscription`
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Monthly_Subscriptions_AFTER_INSERT` AFTER INSERT ON `Monthly_Subscriptions` FOR EACH ROW
BEGIN
	UPDATE `IPG`.`Subscription`
		SET `Subs_CurrentChargeStatus` = 'onQueue',
			`Subs_CurrentChargeStatusDate` = NOW()
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Monthly_Subscriptions_AFTER_UPDATE` AFTER UPDATE ON `Monthly_Subscriptions` FOR EACH ROW
BEGIN
...
CREATE TABLE `Reprocess_Daily_Subscriptions` (
  ...
  `Dasu_AuthorizerCode` varchar(45) NOT NULL,
  `Dasu_AuthorizerReason` varchar(45) NOT NULL,
  PRIMARY KEY (`Dasu_ID`),
  UNIQUE KEY `UNIQUE_Plan_ID_Subs_CurrentPeriodStart_Subs_CurrentPeriodEnd` (`Subs_ID`,`Dasu_CurrentPeriodStart`,`Dasu_CurrentPeriodEnd`),
  UNIQUE KEY `Mosu_ID_UNIQUE` (`Dasu_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `Subscription` (
  ...
  `Subs_CurrentPeriodStart` date DEFAULT NULL,
  `Subs_CurrentPeriodEnd` date DEFAULT NULL,
  `Subs_CurrentPeriod#` int(3) NOT NULL DEFAULT '0',
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Subscription_AFTER_UPDATE` AFTER UPDATE ON `Subscription` FOR EACH ROW
BEGIN
	IF NEW.Subs_CurrentChargeStatus = 'onQueue' OR NEW.Subs_CurrentChargeStatus = 'onQueueDelay' THEN	
	-- IF NEW.Subs_CurrentChargeStatus = 'onQueue' THEN		
		INSERT INTO `IPG`.`AUX_Subscriptions`
			(`Subs_ID`,
			`Plan_ID`,
			`Mcca_ID`,
			`Subs_Quantity`,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Weekly_Subscriptions_AFTER_INSERT` AFTER INSERT ON `Weekly_Subscriptions` FOR EACH ROW
BEGIN
	UPDATE `IPG`.`Subscription`
	SET `Subs_CurrentChargeStatus` = 'onQueue',
		`Subs_CurrentChargeStatusDate` = NOW()
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Weekly_Subscriptions_AFTER_UPDATE` AFTER UPDATE ON `Weekly_Subscriptions` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Yearly_Subscriptions_AFTER_INSERT` AFTER INSERT ON `Yearly_Subscriptions` FOR EACH ROW
BEGIN
	UPDATE `IPG`.`Subscription`
	SET `Subs_CurrentChargeStatus` = 'onQueue',
		`Subs_CurrentChargeStatusDate` = NOW()
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `IPG`.`Yearly_Subscriptions_AFTER_UPDATE` AFTER UPDATE ON `Yearly_Subscriptions` FOR EACH ROW
BEGIN
...
BEGIN	
	...
	loop1: LOOP
        ...
        */
        ...
        SET P_Answer = CONCAT('{ "AffectedRowsUpdate":"',@countRowUpdatedSubscriptions,'","Description":"New Subscriptions going from Pending to Active","Records": [',affectedRow,']}');
...
BEGIN	
	...
	loop1: LOOP
        ...
        */        
        ...
        SET P_Answer = CONCAT('{ "AffectedRowsUpdate":"',@countRowUpdatedSubscriptions,'","Description":"New Subscriptions going from Trialing to Active","Records": [',affectedRow,']}');
...
-- Dump completed on 2015-05-15 20:10:26
