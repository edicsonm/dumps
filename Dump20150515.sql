...
-- Dump completed on 2015-05-15 11:17:42
-- MySQL dump 10.13  Distrib 5.6.19, for Linux (x86_64)
--
...
CREATE TABLE `Monthly_Subscriptions` (
  ...
  `Plan_ID` bigint(20) NOT NULL,
  `Mcca_ID` bigint(20) NOT NULL,
  `Subs_Quantity` decimal(20,0) NOT NULL,
  `Subs_Plan_Amount` varchar(45) NOT NULL,
  `Subs_CurrentPeriodStart` date NOT NULL,
  `Subs_CurrentPeriodEnd` date NOT NULL,
  `Subs_CreationTime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `Subs_Status` enum('Waiting','Charged','Unpaid') NOT NULL,
  `Subs_AuthorizerCode` varchar(45) DEFAULT NULL,
  `Subs_AuthorizerReason` varchar(45) DEFAULT NULL,
  UNIQUE KEY `UNIQUE_Plan_ID_Subs_CurrentPeriodStart_Subs_CurrentPeriodEnd` (`Subs_ID`,`Subs_CurrentPeriodStart`,`Subs_CurrentPeriodEnd`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `SUB_PRC_2015_05_14`
--

DROP TABLE IF EXISTS `SUB_PRC_2015_05_14`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SUB_PRC_2015_05_14` (
  `Subs_ID` bigint(20) NOT NULL DEFAULT '0',
  `Plan_ID` bigint(20) DEFAULT NULL,
  `Mcca_ID` bigint(20) DEFAULT NULL,
  `Subs_Quantity` int(4) DEFAULT NULL,
	...
	loop1: LOOP
        ...
        SET VAR_Subs_CurrentPeriodEnd = VAR_Subs_CurrentPeriodEnd + INTERVAL VAR_Plan_IntervalCount WEEK;
            ...
            INSERT INTO `IPG`.`Monthly_Subscriptions`
				...
				VAR_Subs_CurrentPeriodEnd,
				NOW());
            SET countRowSubscriptions =  countRowSubscriptions + ROW_COUNT();	
            SET i= i + 1;
		END WHILE;
...
BEGIN	
	...
	loop1: LOOP
        ...
        */
        ...
        SET P_Answer = CONCAT('{ "AffectedRowsUpdate":"',@countRowUpdatedSubscriptions,'","Description":"New Subscriptions going from Trialing to Active"}');
