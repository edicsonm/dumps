...
-- Dump completed on 2015-05-07 12:54:27
...
--
-- Table structure for table `SUB_PRC_2015_05_06`
--

DROP TABLE IF EXISTS `SUB_PRC_2015_05_06`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `SUB_PRC_2015_05_06` (
  `Subs_ID` bigint(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-05-07 12:54:28
CREATE DATABASE  IF NOT EXISTS `QRTZ` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `QRTZ`;
-- MySQL dump 10.13  Distrib 5.6.19, for Linux (x86_64)
--
-- Host: localhost    Database: QRTZ
-- ------------------------------------------------------
-- Server version	5.6.24
